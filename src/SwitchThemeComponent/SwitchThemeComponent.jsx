import styles from './SwitchThemeComponent.module.css';

function SwitchThemeComponent ({theme, switchTheme}) {
    ...
    return (<>
        ...
        <div role='button' onClick={lightToDark} className={styles.darkThemeButton}>
        ...
        <div role='button' onClick={darkToLight} className={styles.lightThemeButton}>
